...
lib: build ./build/JH_Json.o ./build/utf8.o ./build/ArrayList.o ./build/HashTable.o 
	mkdir -p lib
	ar rcs ./lib/libJH_Json.a ./build/JH_Json.o ./build/utf8.o ./build/ArrayList.o ./build/HashTable.o

tests: build ./build/JH_Json.o ./build/utf8.o ./build/ArrayList.o ./build/HashTable.o ./tests/tests.c
	$(CC) $(CFLAGS)  ./build/utf8.o ./build/ArrayList.o ./build/HashTable.o  ./build/JH_Json.o ./tests/tests.c -o ./build/tests -lm
...
./build/utf8.o: ./build ./UTF8/utf8.c
	...
	$(CC) -g -c -o ./build/utf8.o ./UTF8/utf8.c -lm
